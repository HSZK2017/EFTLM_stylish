 ...
 * <p>
 * <b>思路来源与致谢</b>：本模块的机制思路借鉴自《The Mimic》模组（merlin204 开发，
 * 已获作者授权借鉴任意代码，致谢见 README 与 mods.toml credits）——"观察敌方出招节奏、
 * 积累自身招式命中经验、据此动态调度招式库"的设计理念。具体实现为独立原创
 * （数据结构与算法不同）：极坐标扇区桶 / 攻击间隔 EMA / 热度衰减调度 / 时长截断窃取。
 * <p>
