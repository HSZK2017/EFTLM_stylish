...
public class TremorEventS {
   public static HitEvent tremorevents() {
      return new HitEvent(0, (entityPatch, entity, invinciblePlayer) -> {
         if (entity instanceof LivingEntity) {
            ...
            if (effect2 != null) {
               ...
               ((LivingEntity)entity).m_7292_(new MobEffectInstance((MobEffect)EMeffects.TREMOR_SCORCH.get(), 8 + duration2, 0, true, false));
            } else if (effect == null) {
               ((LivingEntity)entity).m_7292_(new MobEffectInstance((MobEffect)EMeffects.TREMOR.get(), 8, 0, true, false));
            } else {
               int duration = effect.m_19557_();
               ((LivingEntity)entity).m_7292_(new MobEffectInstance((MobEffect)EMeffects.TREMOR.get(), 8 + duration, 0, true, false));
            }
         }
      });
   }
