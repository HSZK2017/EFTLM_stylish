...
public class EM_Trail extends AnimationTrailParticle {
   public static final ResourceLocation a = new ResourceLocation("epicmoonmod", "a");

   protected EM_Trail(ClientLevel level, LivingEntityPatch<?> owner, Joint joint, AssetAccessor<? extends StaticAnimation> animation, TrailInfo trailInfo) {
            ...
            if (entitypatch == null) {
               ...
               if (animation == null) {
                  ...
                  if (trailInfo.isEmpty()) {
                     ...
                     return result.playable() ? new EM_Trail(level, entitypatch, entitypatch.getArmature().searchJointById(jointId), animation, result) : null;
                  }
               }
            }
         }
