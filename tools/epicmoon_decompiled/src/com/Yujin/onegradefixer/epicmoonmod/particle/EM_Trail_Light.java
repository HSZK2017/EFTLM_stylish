...
public class EM_Trail_Light extends AnimationTrailParticle {
   public ParticleRenderType m_7556_() {
      return EMparticlerendertype.TRAIL_EFFECT_ADDITIVE.apply(this.trailInfo.texturePath());
   }
   ...
   protected EM_Trail_Light(ClientLevel level, LivingEntityPatch<?> owner, Joint joint, AssetAccessor<? extends StaticAnimation> animation, TrailInfo trailInfo) {
               ...
               if (animation == null) {
                  ...
                  if (trailInfo.isEmpty()) {
                     ...
                     return result.playable()
                        ? new EM_Trail_Light(level, entitypatch, entitypatch.getArmature().searchJointById(jointId), animation, result)
                        : null;
                  }
               }
            }
