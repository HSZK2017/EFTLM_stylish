...
public class EM_Trail10 extends AnimationTrailParticle {
   public static final ResourceLocation a = new ResourceLocation("epicmoonmod", "a");

   protected EM_Trail10(ClientLevel level, LivingEntityPatch<?> owner, Joint joint, AssetAccessor<? extends StaticAnimation> animation, TrailInfo trailInfo) {
               ...
               if (animation == null) {
                  ...
                  if (trailInfo.isEmpty()) {
                     ...
                     return result.playable()
                        ? new EM_Trail10(level, entitypatch, entitypatch.getArmature().searchJointById(jointId), animation, result)
                        : null;
                  }
               }
            }
