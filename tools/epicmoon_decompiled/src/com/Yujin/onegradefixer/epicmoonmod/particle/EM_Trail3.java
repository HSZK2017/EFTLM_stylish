...
public class EM_Trail3 extends AnimationTrailParticle {
   public static final ResourceLocation EFFECT = new ResourceLocation("epicmoonmod", "f");
                  ...
                  if (trailInfos.isEmpty()) {
                     ...
                     if (trailIndex >= 0 && trailIndex < infos.size()) {
                        ...
                        if (!result.playable()) {
                           ...
                           return joint == null ? null : new EM_Trail3(level, entityPatch, joint, animation, result);
                        }
                     } else {
                        return null;
                     }
