...
public class DualSin extends MobEffect {
   public static final ResourceLocation b = new ResourceLocation("epicmoonmod", "goki_sin");

   public DualSin(MobEffectCategory pCategory, int pColor) {
   ...
   public void m_6742_(LivingEntity pLivingEntity, int pAmplifier) {
      if (pLivingEntity.m_9236_().f_46443_) {
         ...
         if (mc.f_91074_ == null || pLivingEntity != mc.f_91074_ || !mc.f_91066_.m_92176_().m_90612_()) {
            ParticleEmitterInfo info2 = ParticleEmitterInfo.create(pLivingEntity.m_9236_(), b)
            ...
            AAALevel.addParticle(pLivingEntity.m_9236_(), info2);
         }
      }
   }
