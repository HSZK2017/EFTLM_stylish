   ...
   public static void build(AnimationBuilder builder) {
      ...
      OBSIDIAN_FIST_AUTO1 = builder.nextAccessor(
         ...
         accessor -> (BasicAttackAnimation)new BasicAttackAnimation(
               ...
               .addEvents(new AnimationEvent[]{InTimeEvent.create(0.1F, ReuseableEvents.SUMMON_2_OBSIDIAN_HAND_LEFT, Side.SERVER)})
      );
      OBSIDIAN_FIST_AUTO2 = builder.nextAccessor(
         ...
         accessor -> (BasicAttackAnimation)new BasicAttackAnimation(
               ...
               .addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLUNT)
               .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 3.2F)
               .addEvents(new AnimationEvent[]{InTimeEvent.create(0.1F, ReuseableEvents.SUMMON_2_OBSIDIAN_HAND_RIGHT, Side.SERVER)})
      );
      OBSIDIAN_FIST_AUTO3 = builder.nextAccessor(
         ...
         accessor -> (BasicAttackAnimation)new BasicAttackAnimation(
               ...
               .addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLUNT)
               .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 3.2F)
               .addEvents(new AnimationEvent[]{InTimeEvent.create(0.1F, ReuseableEvents.SUMMON_3_OBSIDIAN_HAND_LEFT, Side.SERVER)})
      );
      ...
      OBSIDIAN_FIST_AIR_SLASH = builder.nextAccessor(
         ...
         accessor -> (AirSlashAnimation)new AirSlashAnimation(
               ...
               .addEvents(new AnimationEvent[]{InTimeEvent.create(0.2F, ReuseableEvents.SUMMON_6_OBSIDIAN_HAND_RIGHT, Side.SERVER)})
      );
      ...
      OBSIDIAN_BIPED_LANDING = builder.nextAccessor(
         ...
         accessor -> (AttackAnimation)new AttackAnimation(
               ...
               .addEvents(new AnimationEvent[]{InTimeEvent.create(0.1F, ReuseableEvents.SUMMON_OBSIDIAN_PILLAR, Side.SERVER)})
      );
      OBSIDIAN_ZOMBIE_ATTACK3 = builder.nextAccessor(
         ...
         accessor -> (AttackAnimation)new AttackAnimation(
               ...
               .addEvents(new AnimationEvent[]{InTimeEvent.create(0.65F, ReuseableEvents.SUMMON_OBSIDIAN_WALL, Side.SERVER)})
      );
