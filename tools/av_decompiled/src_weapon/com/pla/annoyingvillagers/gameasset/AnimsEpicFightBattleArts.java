   ...
   public static void build(AnimationBuilder builder) {
         ...
         access -> (AttackAnimation)new AttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     ...
                     InTimeEvent.create(0.35F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(
                        1.0F,
                              ...
                              if (tridentTip != null) {
                                 ...
                                 if (serverLevel.m_8055_(checkPos).m_60804_(serverLevel, checkPos)) {
                                    TridentLightningBolt tridentLightningBolt = new TridentLightningBolt(
                                       (EntityType)AnnoyingVillagersModEntities.TRIDENT_LIGHTNING_BOLT.get(), serverLevel
                                    );
      ...
      TRIDENT_THROW_1 = builder.nextAccessor(
         ...
         access -> (BasicAttackAnimation)new BasicAttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     InTimeEvent.create(0.0F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.05F, ReuseableEvents.THROW_TRIDENT_HAND_RIGHT, Side.SERVER)
                  }
               )
      );
         ...
         access -> (AttackAnimation)new AttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     ...
                     InTimeEvent.create(0.35F, ReusableSources.PLAY_SOUND, Side.CLIENT).params(SoundEvents.f_12516_),
                     InTimeEvent.create(0.35F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.4F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.4F, ReuseableEvents.THROW_TRIDENT_HAND_RIGHT_EXPLODE, Side.SERVER)
                  }
               )
      );
      ADVANCED_DUELIST_WHIRLEDGE = builder.nextAccessor(
         ...
         access -> (AttackAnimation)new AttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     InTimeEvent.create(0.4F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.4F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_LEFT, Side.SERVER),
                     InTimeEvent.create(0.7F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.7F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_LEFT, Side.SERVER),
                     InTimeEvent.create(1.0F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(1.0F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_LEFT, Side.SERVER)
                  }
               )
      );
      ADVANCED_DUELIST_SHOOTING_STAR = builder.nextAccessor(
         ...
         access -> (AttackAnimation)new AttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     InTimeEvent.create(0.1F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.3F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.5F, ReusableSources.PLAY_SOUND, Side.CLIENT).params(SoundEvents.f_12515_),
                     InTimeEvent.create(0.5F, ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
      ...
      TRIDENT_THROW_3 = builder.nextAccessor(
         ...
         accessor -> (BasicMultipleAttackAnimation)new BasicMultipleAttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     InTimeEvent.create(0.1F, ReuseableEvents.PLAY_TRIDENT_EFFECT_WEAPON_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.3F, ReuseableEvents.PLAY_TRIDENT_EFFECT_WEAPON_RIGHT, Side.SERVER),
                     InTimeEvent.create(
                        0.3F,
                        (livingEntityPatch, self, p) -> {
                           if (((LivingEntity)livingEntityPatch.getOriginal()).m_9236_() instanceof ServerLevel serverLevel) {
                              BlueDemonThunderBeamEntity beam = new BlueDemonThunderBeamEntity(
                                 (EntityType)AnnoyingVillagersModEntities.BLUE_DEMON_THUNDER_BEAM.get(),
                                 serverLevel,
                     ...
                     InTimeEvent.create(0.5F, ReuseableEvents.PLAY_TRIDENT_EFFECT_WEAPON_RIGHT, Side.SERVER)
                  }
               )
      );
   }
