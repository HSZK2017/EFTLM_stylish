...
public class PurpleVillagerKnightEntity extends VillagerArmyEntity {
   public PurpleVillagerKnightEntity(SpawnEntity spawnEntity, Level level) {
      this((EntityType<PurpleVillagerKnightEntity>)AnnoyingVillagersModEntities.PURPLE_VILLAGER_KNIGHT.get(), level);
   }
   ...
   public SpawnGroupData m_6518_(
      ...
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)AnnoyingVillagersModItems.PURPLE_VILLAGER_KNIGHT_HELMET_FIX.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)AnnoyingVillagersModItems.PURPLE_VILLAGER_KNIGHT_CHESTPLATE.get()));
   ...
   public static boolean canSpawn(
      EntityType<PurpleVillagerKnightEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos position, RandomSource random
   ) {
