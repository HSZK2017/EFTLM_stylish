...
public class NullEntity extends HerobrineMob {
   ...
   private void initialSpawn() {
      if (this.m_9236_() instanceof ServerLevel serverLevel) {
         NullWeapon nullSwordEntity = new NullSwordEntity((EntityType<NullSwordEntity>)AnnoyingVillagersModEntities.NULL_SWORD.get(), serverLevel);
         nullSwordEntity.summonNullWeaponForNullEntity(serverLevel, this, "sword");
         NullWeapon nullAxeEntity = new NullAxeEntity((EntityType<NullAxeEntity>)AnnoyingVillagersModEntities.NULL_AXE.get(), serverLevel);
         nullAxeEntity.summonNullWeaponForNullEntity(serverLevel, this, "axe");
         NullWeapon nullPickaxeEntity = new NullPickaxeEntity((EntityType<NullPickaxeEntity>)AnnoyingVillagersModEntities.NULL_PICKAXE.get(), serverLevel);
         nullPickaxeEntity.summonNullWeaponForNullEntity(serverLevel, this, "pickaxe");
         NullWeapon nullShovelEntity = new NullShovelEntity((EntityType<NullShovelEntity>)AnnoyingVillagersModEntities.NULL_SHOVEL.get(), serverLevel);
         nullShovelEntity.summonNullWeaponForNullEntity(serverLevel, this, "shovel");
         NullWeapon nullHoeEntity = new NullHoeEntity((EntityType<NullHoeEntity>)AnnoyingVillagersModEntities.NULL_HOE.get(), serverLevel);
