...
public class BlueVillagerKnightEntity extends VillagerArmyEntity {
   public BlueVillagerKnightEntity(SpawnEntity spawnEntity, Level level) {
      this((EntityType<BlueVillagerKnightEntity>)AnnoyingVillagersModEntities.BLUE_VILLAGER_KNIGHT.get(), level);
   }

   public BlueVillagerKnightEntity(EntityType<BlueVillagerKnightEntity> entitytype, Level level) {
   ...
   public SpawnGroupData m_6518_(
      ...
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)AnnoyingVillagersModItems.BLUE_VILLAGER_KNIGHT_HELMET_FIX.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)AnnoyingVillagersModItems.BLUE_VILLAGER_KNIGHT_CHESTPLATE.get()));
   ...
   public static boolean canSpawn(
      EntityType<BlueVillagerKnightEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos position, RandomSource random
   ) {
