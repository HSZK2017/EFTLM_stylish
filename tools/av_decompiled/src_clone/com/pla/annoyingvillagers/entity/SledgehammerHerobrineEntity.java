...
public class SledgehammerHerobrineEntity extends HerobrineMob {
   public SledgehammerHerobrineEntity(SpawnEntity spawnEntity, Level level) {
      this((EntityType<SledgehammerHerobrineEntity>)AnnoyingVillagersModEntities.SLEDGEHAMMER_HEROBRINE.get(), level);
   }
   ...
   public SledgehammerHerobrineEntity(EntityType<SledgehammerHerobrineEntity> entitytype, Level level) {
      ...
      this.m_20340_(true);
      this.m_21530_();
      this.m_8061_(EquipmentSlot.MAINHAND, new ItemStack((ItemLike)AnnoyingVillagersModItems.OBSIDIAN_SLEDGEHAMMER.get()));
   ...
   public void m_6667_(@NotNull DamageSource damageSource) {
      ...
      if (this.m_9236_() instanceof ServerLevel serverLevel) {
         ...
         eliteHerobrineKnockedEntity.getPersistentData().m_128359_("FromElite", "ObsidianSledgehammer");
         eliteHerobrineKnockedEntity.m_6518_(
            serverLevel, serverLevel.m_6436_(eliteHerobrineKnockedEntity.m_20183_()), MobSpawnType.MOB_SUMMONED, (SpawnGroupData)null, (CompoundTag)null
         );
   ...
   public void m_8119_() {
      super.m_8119_();
      if (!this.m_9236_().m_5776_() && this.f_19797_ % 20 == 0 && this.getState() > 0) {
