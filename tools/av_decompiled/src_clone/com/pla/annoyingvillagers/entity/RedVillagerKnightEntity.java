...
public class RedVillagerKnightEntity extends VillagerArmyEntity {
   public RedVillagerKnightEntity(SpawnEntity spawnEntity, Level level) {
      this((EntityType<RedVillagerKnightEntity>)AnnoyingVillagersModEntities.RED_VILLAGER_KNIGHT.get(), level);
   }
   ...
   protected void m_7472_(@NotNull DamageSource source, int looting, boolean recentlyHit) {
      ...
      if (this.m_9236_() instanceof ServerLevel serverLevel) {
         ...
         ItemStack[] drops = new ItemStack[]{
            new ItemStack((ItemLike)AnnoyingVillagersModItems.HOOKED_DIAMOND_SWORD.get()),
            ...
            new ItemStack(Items.f_42405_),
            new ItemStack((ItemLike)AnnoyingVillagersModItems.COMPRESSED_DIAMOND.get()),
            ...
            new ItemStack(Items.f_42417_),
            new ItemStack(Items.f_42417_),
            new ItemStack(Items.f_42398_),
            new ItemStack(Items.f_42398_),
            new ItemStack(Items.f_42688_),
            new ItemStack(Items.f_42688_),
   ...
   public SpawnGroupData m_6518_(
      ...
      if (!(this.m_21205_().m_41720_() instanceof WoopieTheSwordItem) && !(this.m_21205_().m_41720_() instanceof HookedDiamondSwordItem)) {
         this.m_8061_(EquipmentSlot.OFFHAND, new ItemStack(Items.f_42584_));
      } else {
         this.m_8061_(EquipmentSlot.OFFHAND, new ItemStack((ItemLike)AnnoyingVillagersModItems.HEATER_SHIELD.get()));
      }

      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)AnnoyingVillagersModItems.RED_VILLAGER_KNIGHT_HELMET_FIX.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)AnnoyingVillagersModItems.RED_VILLAGER_KNIGHT_CHESTPLATE.get()));
   ...
   public static boolean canSpawn(
      EntityType<RedVillagerKnightEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos position, RandomSource random
   ) {
