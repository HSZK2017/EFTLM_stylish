...
public class VillagerScoutEntity extends VillagerArmyEntity {
   public VillagerScoutEntity(SpawnEntity spawnentity, Level level) {
      this((EntityType<VillagerScoutEntity>)AnnoyingVillagersModEntities.VILLAGER_SCOUT.get(), level);
   }
   ...
   public SoundEvent getAttackVoiceSound() {
      return (SoundEvent)AnnoyingVillagersModSounds.VILLAGER_SCOUTS_SAY.get();
   }
   ...
   protected void beforeEnderPearlCounter(@NotNull DamageSource damageSource) {
      this.swapOffhandDuringEnderPearlCounter(new ItemStack(Items.f_42383_), 120);
   }
   ...
   public void m_6667_(@NotNull DamageSource pDamageSource) {
      ...
      if (this.m_9236_() instanceof ServerLevel serverLevel) {
         if (!(this.f_19796_.m_188500_() > 0.11)) {
            final Vec3 deathPos = this.m_20182_();
            final float deathYaw = this.m_146908_();
            VillagerUtil.spawnBackupFirework(serverLevel, deathPos);
            new DelayedTask(400) {
               @Override
               public void run() {
                  BlockPos center = BlockPos.m_274446_(deathPos);
                  if (serverLevel.m_46749_(center)) {
   ...
   public SpawnGroupData m_6518_(
      ...
      this.m_21008_(InteractionHand.MAIN_HAND, new ItemStack(Items.f_42383_));
      if (new Random().nextBoolean()) {
         this.m_21008_(InteractionHand.OFF_HAND, new ItemStack(Items.f_42383_));
      } else {
         this.m_21008_(InteractionHand.OFF_HAND, new ItemStack(Items.f_42584_));
      }
      ...
      this.m_8061_(EquipmentSlot.HEAD, new ItemStack((ItemLike)AnnoyingVillagersModItems.VILLAGER_SCOUT_HELMET_FIX.get()));
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack((ItemLike)AnnoyingVillagersModItems.CLASSIC_GOLDEN_CHESTPLATE.get()));
      this.m_8061_(EquipmentSlot.LEGS, new ItemStack((ItemLike)AnnoyingVillagersModItems.CLASSIC_GOLDEN_LEGGINGS.get()));
      this.m_8061_(EquipmentSlot.FEET, new ItemStack((ItemLike)AnnoyingVillagersModItems.CLASSIC_GOLDEN_BOOTS.get()));
   ...
   public static boolean canSpawn(
      EntityType<VillagerScoutEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos position, RandomSource random
   ) {
