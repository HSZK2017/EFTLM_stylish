...
public class VillagerScoutCaptainEntity extends VillagerArmyEntity {
   public VillagerScoutCaptainEntity(SpawnEntity spawnEntity, Level level) {
      this((EntityType<VillagerScoutCaptainEntity>)AnnoyingVillagersModEntities.VILLAGER_SCOUT_CAPTAIN.get(), level);
   }
   ...
   protected void beforeEnderPearlCounter(@NotNull DamageSource damageSource) {
      this.swapOffhandDuringEnderPearlCounter(new ItemStack(Items.f_42388_), 120);
   }
   ...
   public SpawnGroupData m_6518_(
      ...
      this.m_8061_(EquipmentSlot.CHEST, new ItemStack(Items.f_42473_));
      this.m_8061_(EquipmentSlot.LEGS, new ItemStack(Items.f_42474_));
      this.m_8061_(EquipmentSlot.FEET, new ItemStack(Items.f_42475_));
   ...
   public static boolean canSpawn(
      EntityType<VillagerScoutCaptainEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos position, RandomSource random
   ) {
