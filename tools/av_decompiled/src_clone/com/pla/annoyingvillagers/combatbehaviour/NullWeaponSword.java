   ...
   public static final Builder<MobPatch<?>> SWORD = CECombatBehaviors.builder()
      .newBehaviorRoot(
         BehaviorRoot.builder()
            ...
            .maxCooldown(0)
            .addFirstBehavior(
               Behavior.builder().custom(HerobrineCommon::canSpinning).withinDistance(0.0, 45.0).guard(40).addExBehavior(HerobrineCommon::performSpinning)
            )
      )
      .newBehaviorRoot(
         CombatCommon.addRandomCombatChains(
            BehaviorRoot.builder().priority(1.0).weight(40.0).maxCooldown(80),
      ...
      .newBehaviorRoot(CombatBehaviourTemplates.guardRoot(0.5));
}
