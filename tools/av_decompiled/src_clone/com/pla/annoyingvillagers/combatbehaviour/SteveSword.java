...
public class SteveSword {
   public static final Builder<MobPatch<?>> AV_SWORD = CECombatBehaviors.builder()
      ...
      .newBehaviorRoot(CombatBehaviourTemplates.escapeWithAnimationRoot(4.0, Animations.BIPED_ROLL_BACKWARD, AnimsPugilistSteve.KNIFE_CHECK, true))
      .newBehaviorRoot(
   ...
   public static final Builder<MobPatch<?>> AV_DUAL_SWORD = CECombatBehaviors.builder()
      .newBehaviorRoot(CombatBehaviourTemplates.executionRoot(5.0))
      .newBehaviorRoot(CombatBehaviourTemplates.escapeWithGuardRoot(4.0, Animations.BIPED_ROLL_BACKWARD, true))
      .newBehaviorRoot(
         BehaviorRoot.builder()
            .priority(3.0)
            .weight(100.0)
