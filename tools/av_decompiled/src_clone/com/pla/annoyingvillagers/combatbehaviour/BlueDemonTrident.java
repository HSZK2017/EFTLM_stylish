   ...
   public static final Builder<MobPatch<?>> TRIDENT = CECombatBehaviors.builder()
      ...
      .newBehaviorRoot(
         BehaviorRoot.builder()
            ...
            .maxCooldown(600)
            .addFirstBehavior(
               Behavior.builder().custom(CombatCommon::canPerformNormalAttackLogic).withinDistance(0.0, 10.0).animationBehavior(AnimsWom.ELECTRIC_FIELD, 0.0F)
            )
            .addFirstBehavior(
               Behavior.builder()
                  .custom(CombatCommon::canPerformNormalAttackLogic)
