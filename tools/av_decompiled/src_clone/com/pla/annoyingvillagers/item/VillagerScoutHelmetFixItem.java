...
public class VillagerScoutHelmetFixItem extends Item {
   public VillagerScoutHelmetFixItem() {
   ...
   public void m_6883_(ItemStack stack, Level level, Entity entity, int slotId, boolean flag) {
      if (!level.f_46443_ && entity instanceof Player player) {
         if (stack.m_41720_() == this) {
            ItemStack replacement = this.randomDamage(new ItemStack((ItemLike)AnnoyingVillagersModItems.VILLAGER_SCOUT_HELMET.get()));
