...
public abstract class HerobrineObsidianDiamondArmorHelmetItem extends ArmorItem {
   public HerobrineObsidianDiamondArmorHelmetItem(Type type, Properties properties) {
               ...
               public HumanoidModel<?> getHumanoidArmorModel(
                  ...
                  HumanoidModel humanoidmodel1 = new HumanoidModel(
                     new ModelPart(
                        ...
                        Map.of(
                           "head",
                           (new ModelHerobrineObsidianDiamondHelmet(
                                 Minecraft.m_91087_().m_167973_().m_171103_(ModelHerobrineObsidianDiamondHelmet.LAYER_LOCATION)
                              ))
                              .Head,
                           "hat",
