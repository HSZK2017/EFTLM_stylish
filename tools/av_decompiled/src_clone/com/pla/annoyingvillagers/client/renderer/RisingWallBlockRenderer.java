...
public class RisingWallBlockRenderer extends EntityRenderer<RisingWallBlockEntity> {
   ...
   public RisingWallBlockRenderer(Context context) {
      super(context);
   ...
   public void render(
      RisingWallBlockEntity entity, float entityYaw, float partialTicks, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight
   ) {
   ...
   @NotNull
   public ResourceLocation getTextureLocation(@NotNull RisingWallBlockEntity entity) {
