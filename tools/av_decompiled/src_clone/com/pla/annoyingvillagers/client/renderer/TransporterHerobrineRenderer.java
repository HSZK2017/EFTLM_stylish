...
public class TransporterHerobrineRenderer extends HumanoidMobRenderer<HerobrineMob, PlayerModel<HerobrineMob>> {
   ...
   public ResourceLocation getTextureLocation(@NotNull HerobrineMob herobrineMob) {
      return ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/transporter_herobrine.png");
   }
}
