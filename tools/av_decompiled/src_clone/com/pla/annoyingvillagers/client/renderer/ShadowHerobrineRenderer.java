...
public class ShadowHerobrineRenderer extends HumanoidMobRenderer<HerobrineMob, PlayerModel<HerobrineMob>> {
   ...
   public ResourceLocation getTextureLocation(@NotNull HerobrineMob herobrineMob) {
      return herobrineMob instanceof ShadowHerobrineEntity
         ? ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/dark_shadow_herobrine.png")
         : ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/shadow_herobrine.png");
   }
}
