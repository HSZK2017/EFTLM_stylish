...
public class HerobrineChrisRenderer extends HumanoidMobRenderer<HerobrineChrisEntity, PlayerModel<HerobrineChrisEntity>> {
   public HerobrineChrisRenderer(Context context) {
      ...
      ArrowLayer<HerobrineChrisEntity, PlayerModel<HerobrineChrisEntity>> arrowLayer = new ArrowLayer(context, this);
      this.m_115326_(arrowLayer);
   }

   @NotNull
   public ResourceLocation getTextureLocation(HerobrineChrisEntity herobrineChrisEntity) {
      return herobrineChrisEntity.m_21223_() <= 15.0F
         ? ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/infected_chris.png")
         : ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/herobrine.png");
   }
}
