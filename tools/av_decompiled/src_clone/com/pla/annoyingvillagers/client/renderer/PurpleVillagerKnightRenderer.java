...
public class PurpleVillagerKnightRenderer extends HumanoidMobRenderer<PurpleVillagerKnightEntity, PlayerModel<PurpleVillagerKnightEntity>> {
   ...
   @NotNull
   public ResourceLocation getTextureLocation(@NotNull PurpleVillagerKnightEntity purpleVillagerKnightEntity) {
      return purpleVillagerKnightEntity.m_21224_()
         ? ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/purple_villager_knight_dead.png")
         : ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/purple_villager_knight.png");
   }
}
