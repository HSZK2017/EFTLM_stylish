...
public class BlueDemonRenderer extends HumanoidMobRenderer<BlueDemonEntity, PlayerModel<BlueDemonEntity>> {
   ...
   @NotNull
   public ResourceLocation getTextureLocation(@NotNull BlueDemonEntity blueDemonEntity) {
      return blueDemonEntity.getState() == 2
         ? ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/blue_demon_exhausted.png")
         : ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/blue_demon.png");
   }
}
