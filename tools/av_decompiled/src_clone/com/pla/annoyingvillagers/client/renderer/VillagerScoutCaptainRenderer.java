...
public class VillagerScoutCaptainRenderer extends HumanoidMobRenderer<VillagerScoutCaptainEntity, PlayerModel<VillagerScoutCaptainEntity>> {
   public VillagerScoutCaptainRenderer(Context context) {
      ...
      ArrowLayer<VillagerScoutCaptainEntity, PlayerModel<VillagerScoutCaptainEntity>> arrowLayer = new ArrowLayer(context, this);
      this.m_115326_(arrowLayer);
   }

   @NotNull
   public ResourceLocation getTextureLocation(@NotNull VillagerScoutCaptainEntity villagerScoutCaptainEntity) {
      return villagerScoutCaptainEntity.m_21224_()
