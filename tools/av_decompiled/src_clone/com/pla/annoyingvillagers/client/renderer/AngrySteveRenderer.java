...
public class AngrySteveRenderer extends HumanoidMobRenderer<AngrySteveEntity, PlayerModel<AngrySteveEntity>> {
   ...
   @NotNull
   public ResourceLocation getTextureLocation(@NotNull AngrySteveEntity angrySteveEntity) {
      return angrySteveEntity.m_21224_()
         ? ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/steve_dead.png")
         : ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/angry_steve.png");
   }
}
