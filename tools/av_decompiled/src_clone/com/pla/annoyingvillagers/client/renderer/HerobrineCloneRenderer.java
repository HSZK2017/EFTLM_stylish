...
public class HerobrineCloneRenderer extends HumanoidMobRenderer<HerobrineCloneEntity, PlayerModel<HerobrineCloneEntity>> {
   ...
   @NotNull
   public ResourceLocation getTextureLocation(@NotNull HerobrineCloneEntity herobrineCloneEntity) {
      return ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/herobrine.png");
   }
}
