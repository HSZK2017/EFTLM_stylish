...
@OnlyIn(Dist.CLIENT)
public class RenderRedAxe extends RenderItemBase {
   public RenderRedAxe(JsonElement json) {
      super(json);
   }
   ...
   public void renderItemInHand(
      ...
      if (livingEntityPatch != null) {
         ...
         if (dynamicAnimation != AVAnimations.RED_AXE_ATTACK) {
            ItemStack itemstack = new ItemStack((ItemLike)AnnoyingVillagersModItems.RED_AXE.get());
            poseStack.m_85836_();
            ...
            ItemStack itemstack = new ItemStack((ItemLike)AnnoyingVillagersModItems.GIANT_RED_AXE.get());
            poseStack.m_85836_();
            MathUtils.mulStack(poseStack, openmatrix4f);
            Minecraft.m_91087_()
               .m_91291_()
