...
public class RenderShadowObsidianPillar extends RenderItemBase {
   ...
   public void renderItemInHand(
      ...
      if (livingEntityPatch != null
         && ((LivingEntity)livingEntityPatch.getOriginal()).m_21205_().m_41720_().equals(AnnoyingVillagersModItems.SHADOW_OBSIDIAN_PILLAR.get())) {
         ...
         if (dynamicAnimation != AnimsWom.OBSIDIAN_ANTITHEUS_ASCENDED_DEATHFALL
            ...
            if ((
                  dynamicAnimation != AnimsEpicFight.OBSIDIAN_FIST_AIR_SLASH
               ...
               if ((
                  ...
                  && entityState.getLevel() > 1) {
                  ItemStack itemstack = new ItemStack((ItemLike)AnnoyingVillagersModItems.SHADOW_OBSIDIAN_PILLAR.get());
                  poseStack.m_85836_();
                  ...
                  poseStack.m_85849_();
                  if (((LivingEntity)livingEntityPatch.getOriginal()).m_21206_().m_41720_().equals(AnnoyingVillagersModItems.SHADOW_OBSIDIAN_SWORD.get())) {
                  ...
                  poseStack.m_85849_();
                  if (((LivingEntity)livingEntityPatch.getOriginal()).m_21206_().m_41720_().equals(AnnoyingVillagersModItems.SHADOW_OBSIDIAN_SWORD.get())) {
                     itemstack = new ItemStack((ItemLike)AnnoyingVillagersModItems.SHADOW_OBSIDIAN_SWORD.get());
                     poseStack.m_85836_();
                     MathUtils.mulStack(poseStack, openmatrix4foffHand);
               ...
               ItemStack itemstack = new ItemStack((ItemLike)AnnoyingVillagersModItems.SHADOW_OBSIDIAN_BURST.get());
               if (itemstack.m_41783_() != null) {
