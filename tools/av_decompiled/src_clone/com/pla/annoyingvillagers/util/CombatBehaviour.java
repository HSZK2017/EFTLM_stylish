                     ...
                     if (!CombatBehaviour.trackedNpcHoldsMainHandItem(entity, isEnchanted ? Items.f_42437_ : Items.f_42436_)) {
                        ...
                        if (patch == null) {
                           ...
                           if (!(currentAnim.get() instanceof AttackAnimation)
                              ...
                              && !CombatCommon.canEscape((MobPatch<?>)livingEntityPatch)) {
                              final Runnable bite = () -> CombatBehaviour.performEatingGoldenAppleActionMainHand(entity, levelaccessor, patch, isEnchanted);
                              int biteDelay = 4;
                              int totalBites = 7;
                                    ...
                                    if (entity.m_6084_()) {
                                       if (!CombatBehaviour.isTrackedHealingCancelled(entity)) {
                                          if (!CombatBehaviour.trackedNpcHoldsMainHandItem(entity, isEnchanted ? Items.f_42437_ : Items.f_42436_)) {
                                             ...
                                             if (levelaccessor instanceof ServerLevel serverLevel) {
                                                serverLevel.m_5594_(null, entity.m_20183_(), SoundEvents.f_12321_, SoundSource.NEUTRAL, 1.5F, 1.0F);
                                             }
                                          }
                                       }
                                    }
                                    ...
                                    if (entity.m_6084_()) {
                                       if (!CombatBehaviour.isTrackedHealingCancelled(entity)) {
                                          if (!CombatBehaviour.trackedNpcHoldsMainHandItem(entity, isEnchanted ? Items.f_42437_ : Items.f_42436_)) {
                                             ...
                                             LivingEntityPatch<?> livingEntityPatch1 = (LivingEntityPatch<?>)EpicFightCapabilities.getEntityPatch(
                                                entity, LivingEntityPatch.class
                                             );
                                             if (!entity.m_9236_().m_5776_() && entity.m_20194_() != null && livingEntityPatch1 != null) {
                                                livingEntityPatch1.playAnimationSynchronized(AVAnimations.IDLE_BREAK, 0.0F);
                                             }

                                             if (entity instanceof PlayerNpcEntity playerNpcEntity) {
                                                livingEntity.m_21008_(InteractionHand.MAIN_HAND, playerNpcEntity.getMainWeaponItem().m_41777_());
                                             }

                                             if (entity instanceof AVNpc AVNpc) {
                                                if (livingEntityPatch1 != null
                                                   && AVNpc instanceof SteveEntity
                                                   && CombatCommon.canSwitchWeapon((MobPatch<?>)livingEntityPatch1)) {
                                                   CombatCommon.switchWeapon((MobPatch<?>)livingEntityPatch1);
                                                } else {
                                                   livingEntity.m_21008_(InteractionHand.MAIN_HAND, AVNpc.getMainWeaponItem().m_41777_());
                                                }
                                             }
                                             ...
                                             if (!livingEntity.m_9236_().m_5776_()) {
                                                if (isEnchanted) {
                                                   ...
                                                   livingEntity.m_7292_(new MobEffectInstance(MobEffects.f_19607_, 6000, 0));
                                                } else {
                                             ...
                                             if (entity instanceof AVNpc AVNpcx) {
                                                AVNpcx.setHealing(false);
                                             }
                                          }
                                       }
                                    }
                     ...
                     if (!CombatBehaviour.trackedNpcHoldsMainHandItem(entity, Items.f_42589_)) {
                        ...
                        if (patch == null) {
                           ...
                           if (!(currentAnim.get() instanceof AttackAnimation)
                              && !EpicfightUtil.isLongHitAnimation(currentAnim, patch)
                              && !CombatCommon.canEscape((MobPatch<?>)livingEntityPatch)) {
                              final Runnable bite = () -> CombatBehaviour.performDrinkingHealingPotionActionMainhand(entity, levelaccessor, patch);
                              int biteDelay = 4;
                              int totalBites = 7;
                                    ...
                                    if (entity.m_6084_()) {
                                       if (!CombatBehaviour.isTrackedHealingCancelled(entity)) {
                                          if (!CombatBehaviour.trackedNpcHoldsMainHandItem(entity, Items.f_42589_)) {
                                             ...
                                             if (!livingEntity.m_9236_().m_5776_()) {
                                                if (isHostile) {
                                                   livingEntity.m_7292_(new MobEffectInstance(MobEffects.f_19602_, 40, 0));
                                                } else {
