...
public class HerobrineEyesUtil {
   ...
   private static final ResourceLocation DEFAULT_UP_1_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "annoyingvillagers", "textures/entities/herobrine_eyes/default/up_1.png"
   );
   private static final ResourceLocation DEFAULT_DOWN_1_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "annoyingvillagers", "textures/entities/herobrine_eyes/default/down_1.png"
   );
   private static final ResourceLocation SQUARE_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "annoyingvillagers", "textures/entities/herobrine_eyes/square/default.png"
   );
   private static final ResourceLocation SQUARE_DOWN_1_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "annoyingvillagers", "textures/entities/herobrine_eyes/square/down_1.png"
   );
   private static final ResourceLocation SQUARE_UP_1_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "annoyingvillagers", "textures/entities/herobrine_eyes/square/up_1.png"
   );
   private static final ResourceLocation SQUARE_UP_2_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "annoyingvillagers", "textures/entities/herobrine_eyes/square/up_2.png"
   );
   private static final ResourceLocation VERTICAL_FAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "annoyingvillagers", "textures/entities/herobrine_eyes/vertical/default_far.png"
   );
   private static final ResourceLocation VERTICAL_CLOSE_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "annoyingvillagers", "textures/entities/herobrine_eyes/vertical/default_close.png"
   );
   ...
   static {
      ...
      eyeTextures.put("Darkosto", ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/herobrine_eyes/vertical/far_down.png"));
      ...
      eyeTextures.put("nekosune", ResourceLocation.fromNamespaceAndPath("annoyingvillagers", "textures/entities/herobrine_eyes/single/default_far_down_1.png"));
