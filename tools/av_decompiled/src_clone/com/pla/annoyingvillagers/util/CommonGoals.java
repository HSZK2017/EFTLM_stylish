...
public class CommonGoals {
   ...
   public static void registerGoalForVillagerKnightNpc(final PathfinderMob mob) {
      ...
      mob.f_21345_.m_25352_(6, new RandomStrollGoal(mob, 1.0) {
         public boolean m_8036_() {
            return !CommonGoals.hasCombatTarget(this.f_25725_) && super.m_8036_();
         }

         public boolean m_8045_() {
            return !CommonGoals.hasCombatTarget(this.f_25725_) && super.m_8045_();
         }

         public void m_8041_() {
            super.m_8041_();
            if (CommonGoals.hasCombatTarget(this.f_25725_)) {
               this.f_25725_.m_21573_().m_26573_();
            }
         }
      });
      mob.f_21345_.m_25352_(7, new FollowMobGoal(mob, 1.3, 20.0F, 15.0F) {
         public boolean m_8036_() {
            return !CommonGoals.hasCombatTarget(mob) && super.m_8036_();
         }

         public boolean m_8045_() {
            return !CommonGoals.hasCombatTarget(mob) && super.m_8045_();
         }

         public void m_8041_() {
            super.m_8041_();
            if (CommonGoals.hasCombatTarget(mob)) {
      ...
      mob.f_21345_.m_25352_(10, new RandomLookAroundGoal(mob) {
         public boolean m_8036_() {
            return !CommonGoals.hasCombatTarget(mob) && super.m_8036_();
         }
