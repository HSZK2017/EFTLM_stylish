...
public class NullPatch extends CEHumanoidPatch implements CustomExecuteEntity {
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions.put(WeaponCategories.SWORD, ImmutableMap.of(Styles.TWO_HAND, HerobrineNullWeapon.NULL_WEAPON));
      this.guardHitMotions.put(WeaponCategories.SWORD, ImmutableMap.of(Styles.TWO_HAND, List.of(Animations.GREATSWORD_GUARD_HIT)));
   }
