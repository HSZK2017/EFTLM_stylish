...
public class BlueDemonPatch extends CEHumanoidPatch implements CustomExecuteEntity {
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions.put(WeaponCategories.SPEAR, ImmutableMap.of(Styles.TWO_HAND, BlueDemonTrident.TRIDENT));
      this.guardHitMotions.put(WeaponCategories.SPEAR, ImmutableMap.of(Styles.TWO_HAND, List.of(Animations.SWORD_DUAL_GUARD_HIT)));
      this.weaponLivingMotions
         .put(
      ...
      this.weaponAttackMotions.put(WeaponCategories.GREATSWORD, ImmutableMap.of(Styles.TWO_HAND, BlueDemonLegendarySword.LEGENDARY_SWORD));
