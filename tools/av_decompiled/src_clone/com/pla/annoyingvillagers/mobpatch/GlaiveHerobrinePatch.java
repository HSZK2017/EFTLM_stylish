...
public class GlaiveHerobrinePatch extends CEHumanoidPatch implements CustomExecuteEntity {
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions.put(WeaponCategories.SPEAR, ImmutableMap.of(Styles.TWO_HAND, HerobrineEnderGlaive.ENDER_GLAIVE));
      this.guardHitMotions.put(WeaponCategories.SPEAR, ImmutableMap.of(Styles.ONE_HAND, List.of(Animations.SPEAR_GUARD_HIT)));
   }
