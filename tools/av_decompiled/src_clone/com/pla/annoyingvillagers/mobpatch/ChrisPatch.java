...
public class ChrisPatch extends CEHumanoidPatch implements CustomExecuteEntity {
   public ChrisPatch() {
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions.put(WeaponCategories.NOT_WEAPON, ImmutableMap.of(Styles.ONE_HAND, AvNpcFist.FIST));
      this.weaponLivingMotions
         .put(
      ...
      this.weaponAttackMotions.put(WeaponCategories.FIST, ImmutableMap.of(Styles.ONE_HAND, AvNpcFist.FIST));
      this.weaponLivingMotions
         .put(
      ...
      this.weaponAttackMotions.put(WeaponCategories.SWORD, ImmutableMap.of(Styles.ONE_HAND, AvNpcSword.AV_SWORD, Styles.TWO_HAND, AvNpcSword.AV_DUAL_SWORD));
