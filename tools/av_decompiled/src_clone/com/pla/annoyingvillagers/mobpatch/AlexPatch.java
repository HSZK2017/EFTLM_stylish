...
import com.pla.annoyingvillagers.combatbehaviour.AlexSword;
...
public class AlexPatch extends CEHumanoidPatch implements CustomExecuteEntity {
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions
         .put(WeaponCategories.SWORD, ImmutableMap.of(Styles.ONE_HAND, AlexSword.THUNDER_DIAMOND_BLADE, Styles.TWO_HAND, AlexSword.DUAL_THUNDER_DIAMOND_BLADE));
