...
public class NullWeaponPatch extends CEHumanoidPatch implements CustomExecuteEntity {
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions.put(WeaponCategories.SWORD, ImmutableMap.of(Styles.ONE_HAND, NullWeaponSword.SWORD));
      ...
      this.weaponAttackMotions.put(WeaponCategories.AXE, ImmutableMap.of(Styles.ONE_HAND, NullWeaponSword.SWORD));
      this.guardHitMotions
         .put(
            WeaponCategories.AXE,
            ImmutableMap.of(
      ...
      this.weaponAttackMotions.put(WeaponCategories.PICKAXE, ImmutableMap.of(Styles.ONE_HAND, NullWeaponSword.SWORD));
      this.guardHitMotions
         .put(
            WeaponCategories.PICKAXE,
            ImmutableMap.of(
      ...
      this.weaponAttackMotions.put(WeaponCategories.SHOVEL, ImmutableMap.of(Styles.ONE_HAND, NullWeaponSword.SWORD));
      this.guardHitMotions
         .put(
            WeaponCategories.SHOVEL,
            ImmutableMap.of(
      ...
      this.weaponAttackMotions.put(WeaponCategories.HOE, ImmutableMap.of(Styles.ONE_HAND, NullWeaponSword.SWORD));
      this.guardHitMotions
         .put(
            WeaponCategories.HOE,
            ImmutableMap.of(
