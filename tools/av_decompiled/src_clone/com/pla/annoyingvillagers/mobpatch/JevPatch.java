...
public class JevPatch extends CEHumanoidPatch implements CustomExecuteEntity {
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions.put(WeaponCategories.NOT_WEAPON, ImmutableMap.of(Styles.ONE_HAND, JevFist.FIST));
      this.weaponLivingMotions
         .put(
      ...
      this.weaponAttackMotions.put(WeaponCategories.FIST, ImmutableMap.of(Styles.ONE_HAND, JevFist.FIST));
   }
