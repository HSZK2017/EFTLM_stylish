...
public class TransporterHerobrinePatch extends HerobrineClonePatch {
   ...
   private boolean isHookedEntity() {
      if (this.getOriginal() instanceof TransporterHerobrineCloneEntity transporter && transporter.isHooked()) {
         return true;
      }
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions.put(WeaponCategories.NOT_WEAPON, ImmutableMap.of(Styles.ONE_HAND, TransporterHerobrineFist.TRANSPORTER_HEROBRINE_FIST));
      this.weaponLivingMotions
         .put(
      ...
      this.weaponAttackMotions.put(WeaponCategories.FIST, ImmutableMap.of(Styles.ONE_HAND, TransporterHerobrineFist.TRANSPORTER_HEROBRINE_FIST));
   }
}
