...
public class AegisHerobrinePatch extends CEHumanoidPatch implements CustomExecuteEntity {
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions.put(WeaponCategories.SWORD, ImmutableMap.of(Styles.TWO_HAND, HerobrineEnderAegis.ENDER_AEGIS));
   ...
   public void onGuardHit(DamageSource damageSource) {
      ...
      if (this.getOriginal() instanceof HerobrineMob herobrineMob && herobrineMob.getState() > 0 && herobrineMob.m_9236_() instanceof ServerLevel serverLevel) {
