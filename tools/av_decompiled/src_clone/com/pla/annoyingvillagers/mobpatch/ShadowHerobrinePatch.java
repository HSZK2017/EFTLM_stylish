...
public class ShadowHerobrinePatch extends CEHumanoidPatch implements CustomExecuteEntity {
   ...
   protected void setWeaponMotions() {
      ...
      this.weaponAttackMotions.put(WeaponCategories.NOT_WEAPON, ImmutableMap.of(Styles.ONE_HAND, HerobrineEnderEye.ENDER_EYE));
      this.weaponLivingMotions
         .put(
      ...
      this.weaponAttackMotions.put(WeaponCategories.FIST, ImmutableMap.of(Styles.ONE_HAND, HerobrineEnderEye.ENDER_EYE));
      this.weaponLivingMotions
         .put(
      ...
      this.weaponAttackMotions.put(WeaponCategories.SWORD, ImmutableMap.of(Styles.TWO_HAND, HerobrineShadowObsidianPillar.SHADOW_OBSIDIAN_PILLAR_WEAPON));
   }

   protected Builder<MobPatch<?>> getCustomWeaponMotionBuilder() {
      CapabilityItem mainHandCap = this.getHoldingItemCapability(InteractionHand.MAIN_HAND);
      Builder<MobPatch<?>> customOverride = MobPatchCommon.overideCustomWeaponMotionBuilderForShadowHerobrine(mainHandCap, mainHandCap.getStyle(this));
