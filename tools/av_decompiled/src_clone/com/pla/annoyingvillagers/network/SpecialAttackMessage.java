...
public class SpecialAttackMessage {
   ...
   public SpecialAttackMessage(int type, int presses, Vec3 crosshairTarget) {
      ...
      if (crosshairTarget != null) {
         this.crosshairTargetX = crosshairTarget.f_82479_;
         this.crosshairTargetY = crosshairTarget.f_82480_;
         this.crosshairTargetZ = crosshairTarget.f_82481_;
      }
   }
   ...
   public static void handler(SpecialAttackMessage specialAttackMessage, Supplier<Context> supplier) {
      ...
      context.enqueueWork(
         () -> pressAction(
               Objects.requireNonNull(context.getSender()), specialAttackMessage.type, specialAttackMessage.presses, specialAttackMessage.getCrosshairTarget()
            )
      );
