   ...
   public static void build(AnimationBuilder builder) {
      ...
      OBSIDIAN_INFERNAL_AUTO_1 = builder.nextAccessor(
         ...
         accessor -> (BasicMultipleAttackAnimation)new BasicMultipleAttackAnimation(
               ...
               .addEvents(new AnimationEvent[]{InTimeEvent.create(0.2F, AVAnimations.ReuseableEvents.SUMMON_6_OBSIDIAN_HAND_LEFT, Side.SERVER)})
      );
      OBSIDIAN_INFERNAL_AUTO_2 = builder.nextAccessor(
         ...
         accessor -> (BasicMultipleAttackAnimation)new BasicMultipleAttackAnimation(
               ...
               .addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLUNT)
               .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 5.4F)
               .addEvents(new AnimationEvent[]{InTimeEvent.create(0.1F, AVAnimations.ReuseableEvents.SUMMON_OBSIDIAN_WALL, Side.SERVER)})
      );
   }
}
