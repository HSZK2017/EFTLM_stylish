   ...
   public static void build(AnimationBuilder builder) {
      ...
      LEGENDARY_SWORD_HEAVY_ATTACK = builder.nextAccessor(
         ...
         accessor -> (HeavyAttackAnimation)new HeavyAttackAnimation(
               ...
               .addEvents(
                  new InTimeEvent[]{
                     InTimeEvent.create(0.6F, ReuseableEvents.TORMENT_GROUNDSLAM, Side.CLIENT),
                     InTimeEvent.create(0.6F, AVAnimations.ReuseableEvents.SHOCK_WAVE, Side.SERVER)
                  }
               )
      );
      ...
      SPEAR_GUARD_HIT = builder.nextAccessor(
         ...
         accessor -> (GuardAnimation)new GuardAnimation(0.05F, 0.2F, accessor, humanoidArmature)
               .addEvents(
                  new InTimeEvent[]{
                     InTimeEvent.create(0.1F, AVAnimations.ReuseableEvents.FAST_SPINNING, Side.CLIENT),
                     InTimeEvent.create(0.2F, AVAnimations.ReuseableEvents.FAST_SPINNING, Side.CLIENT),
                     InTimeEvent.create(0.3F, AVAnimations.ReuseableEvents.FAST_SPINNING, Side.CLIENT),
                     InTimeEvent.create(0.4F, AVAnimations.ReuseableEvents.FAST_SPINNING, Side.CLIENT)
                  }
               )
      );
      ...
      DUAL_SWORD_SKILL = builder.nextAccessor(
         ...
         accessor -> (BasicAttackAnimation)new BasicAttackAnimation(
               ...
               .addState(EntityState.TURNING_LOCKED, false)
               .addState(EntityState.LOCKON_ROTATE, false)
               .addEvents(new AnimationEvent[]{InTimeEvent.create(2.5F, AVAnimations.ReuseableEvents.END_ATTACK, Side.BOTH)})
               .addProperty(StaticAnimationProperty.PLAY_SPEED_MODIFIER, ReusableSources.CONSTANT_ONE)
      );
      ...
      LEGENDARY_SWORD_AUTO_4 = builder.nextAccessor(
         ...
         accessor -> (BasicMultipleAttackAnimation)new BasicMultipleAttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     InTimeEvent.create(0.45F, ReuseableEvents.TORMENT_GROUNDSLAM, Side.CLIENT), InTimeEvent.create(1.2F, (livingEntityPatch, self, p) -> {
      ...
      OBSIDIAN_FIST_DASH = builder.nextAccessor(
         ...
         accessor -> (BasicMultipleAttackAnimation)new BasicMultipleAttackAnimation(
               ...
               .addProperty(AttackPhaseProperty.STUN_TYPE, StunType.KNOCKDOWN)
               .addProperty(StaticAnimationProperty.PLAY_SPEED_MODIFIER, ReusableSources.CONSTANT_ONE)
               .addEvents(new AnimationEvent[]{InTimeEvent.create(0.6F, AVAnimations.ReuseableEvents.THROW_OBSIDIAN, Side.SERVER)})
      );
      ...
      TRIDENT_THROW_2 = builder.nextAccessor(
         ...
         accessor -> (BasicAttackAnimation)new BasicAttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     InTimeEvent.create(0.1F, AVAnimations.ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_LEFT, Side.SERVER),
                     InTimeEvent.create(0.6F, AVAnimations.ReuseableEvents.THROW_TRIDENT_HAND_LEFT, Side.SERVER)
                  }
               )
      );
      TRIDENT_THROW_LEGENDARY = builder.nextAccessor(
         ...
         accessor -> (BasicAttackAnimation)new BasicAttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     InTimeEvent.create(0.1F, AVAnimations.ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_LEFT, Side.SERVER),
                     InTimeEvent.create(0.4F, AVAnimations.ReuseableEvents.THROW_TRIDENT_HAND_LEFT, Side.SERVER)
                  }
               )
      );
