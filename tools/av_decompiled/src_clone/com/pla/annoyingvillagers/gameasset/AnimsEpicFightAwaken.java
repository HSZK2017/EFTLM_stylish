   ...
   public static void build(AnimationBuilder builder) {
      ...
      DP_THROW_BLADE_AUTO_1 = builder.nextAccessor(
         ...
         accessor -> (AttackAnimation)new AttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     InTimeEvent.create(0.15F, AVAnimations.ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_LEFT, Side.SERVER),
                     InTimeEvent.create(0.15F, AVAnimations.ReuseableEvents.THROW_TRIDENT_HAND_LEFT, Side.SERVER),
                     InTimeEvent.create(0.23F, AVAnimations.ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.23F, AVAnimations.ReuseableEvents.THROW_TRIDENT_HAND_RIGHT, Side.SERVER)
                  }
               )
               .addProperty(
                  StaticAnimationProperty.PLAY_SPEED_MODIFIER, (PlaybackSpeedModifier)(self, livingEntityPatch, speed, prevElapsedTime, elapsedTime) -> 2.0F
      ...
      DP_THROW_BLADE_AUTO_2 = builder.nextAccessor(
         ...
         accessor -> (AttackAnimation)new AttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     InTimeEvent.create(0.43F, AVAnimations.ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_LEFT, Side.SERVER),
                     InTimeEvent.create(0.43F, AVAnimations.ReuseableEvents.THROW_TRIDENT_HAND_LEFT_LIGHTNING, Side.SERVER),
                     InTimeEvent.create(0.43F, AVAnimations.ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.43F, AVAnimations.ReuseableEvents.THROW_TRIDENT_HAND_RIGHT_LIGHTNING, Side.SERVER)
                  }
               )
               .addProperty(
         ...
         accessor -> (AttackAnimation)new AttackAnimation(
               ...
               .addEvents(
                  new AnimationEvent[]{
                     ...
                     InTimeEvent.create(0.2F, AVAnimations.ReuseableEvents.THROW_TRIDENT_HAND_LEFT, Side.SERVER),
                     InTimeEvent.create(0.2F, AVAnimations.ReuseableEvents.PLAY_TRIDENT_EFFECT_HAND_RIGHT, Side.SERVER),
                     InTimeEvent.create(0.2F, AVAnimations.ReuseableEvents.THROW_TRIDENT_HAND_RIGHT, Side.SERVER)
                  }
               )
      );
