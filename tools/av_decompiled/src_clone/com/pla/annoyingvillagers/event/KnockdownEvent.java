...
public class KnockdownEvent {
   ...
   public static void onEntityAttacked(LivingHurtEvent livingHurtEvent) {
      if (livingHurtEvent != null && livingHurtEvent.getEntity() != null) {
         LivingEntityPatch<?> livingEntityPatch = (LivingEntityPatch<?>)EpicFightCapabilities.getEntityPatch(
            livingHurtEvent.getEntity(), LivingEntityPatch.class
         );
         if (livingEntityPatch != null && livingHurtEvent.getEntity().m_9236_() instanceof ServerLevel) {
