...
public class GregData extends SavedData {
   ...
   public static GregData get(ServerLevel serverLevel) {
      return (GregData)serverLevel.m_8895_().m_164861_(GregData::load, GregData::new, "av_singleton_greg");
   }

   public static GregData load(CompoundTag compoundTag) {
      GregData gregData = new GregData();
      if (compoundTag.m_128403_("activeId")) {
         gregData.activeId = compoundTag.m_128342_("activeId");
      }

      if (compoundTag.m_128425_("claimTick", 4)) {
         gregData.claimTick = compoundTag.m_128454_("claimTick");
      }
   ...
   public boolean isOccupied(ServerLevel serverLevel) {
      if (this.activeId != null) {
         ...
         if (entity instanceof HerobrineGregEntity && entity.m_6084_()) {
            return true;
         } else {
            this.activeId = null;
            this.m_77762_();
