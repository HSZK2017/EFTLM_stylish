...
public class AvNpcXSword {
   public static final Builder<MobPatch<?>> X_SWORD = AvNpcCombatBehaviorBuilder.weapon(
      CombatCommon.animations(
         AnimationsX.SWORD_AUTO1, AnimationsX.SWORD_AUTO2, AnimationsX.SWORD_AUTO3, ExtraAnimations.SWORD_AUTO4, ExtraAnimations.SWORD_AUTO5
      ),
      ...
      CombatCommon.animations(AnimationsX.SWORD_DASH, AnimationsX.SWORD_AIR_SLASH, AnimationsX.SWEEPING_EDGE)
   );
   public static final Builder<MobPatch<?>> X_DUAL_SWORD = AvNpcCombatBehaviorBuilder.weapon(
      ...
      CombatCommon.animations(AnimationsX.SWORD_DUAL_DASH, AnimationsX.SWORD_DUAL_AIR_SLASH, AnimationsX.DANCING_EDGE)
   );
}
