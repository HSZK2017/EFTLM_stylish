...
public class AvNpcXFist {
   public static final Builder<MobPatch<?>> X_FIST = AvNpcCombatBehaviorBuilder.fist(
      CombatCommon.animations(AnimationsX.FIST_AUTO1, AnimationsX.FIST_AUTO2, AnimationsX.FIST_AUTO3, ExtraAnimations.FIST_AUTO4, ExtraAnimations.FIST_AUTO5),
      ...
      CombatCommon.animations(AnimationsX.FIST_DASH, AnimationsX.FIST_AIR_SLASH, AnimationsX.RELENTLESS_COMBO)
   );
}
