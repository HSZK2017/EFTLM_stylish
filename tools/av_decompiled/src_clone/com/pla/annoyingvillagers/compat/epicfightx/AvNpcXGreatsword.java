...
public class AvNpcXGreatsword {
   public static final Builder<MobPatch<?>> X_GREATSWORD = AvNpcCombatBehaviorBuilder.weapon(
      ...
      CombatCommon.animations(AnimationsX.GREATSWORD_DASH, AnimationsX.GREATSWORD_AIR_SLASH),
      CombatCommon.animations(AnimsPugilistSteve.GIANT_WHIRLWIND, AnimationsX.STEEL_WHIRLWIND_CHARGING, AnimationsX.STEEL_WHIRLWIND)
   );
}
