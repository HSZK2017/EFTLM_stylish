...
public class AvNpcXDagger {
   public static final Builder<MobPatch<?>> X_DAGGER = AvNpcCombatBehaviorBuilder.weapon(
      CombatCommon.animations(
         AnimationsX.DAGGER_AUTO1, AnimationsX.DAGGER_AUTO2, AnimationsX.DAGGER_AUTO3, ExtraAnimations.DAGGER_AUTO4, ExtraAnimations.DAGGER_AUTO5
      ),
      ...
      CombatCommon.animations(AnimationsX.DAGGER_DASH, AnimationsX.DAGGER_AIR_SLASH, AnimationsX.EVISCERATE_FIRST, AnimationsX.EVISCERATE_SECOND)
   );
