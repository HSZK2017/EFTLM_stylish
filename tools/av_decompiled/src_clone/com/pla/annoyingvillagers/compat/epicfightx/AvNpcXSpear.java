...
public class AvNpcXSpear {
   public static final Builder<MobPatch<?>> X_SPEAR_SHIELD = AvNpcCombatBehaviorBuilder.weapon(
      CombatCommon.animations(AnimationsX.SPEAR_ONEHAND_AUTO, ExtraAnimations.SPEAR_ONEHAND_AUTO1, ExtraAnimations.SPEAR_ONEHAND_AUTO2),
      CombatCommon.animations(AnimsPugilistSteve.SPEAR_THRUST),
      CombatCommon.animations(AnimationsX.SPEAR_DASH, AnimationsX.SPEAR_ONEHAND_AIR_SLASH, AnimationsX.HEARTPIERCER)
   );
   public static final Builder<MobPatch<?>> X_SPEAR = AvNpcCombatBehaviorBuilder.weapon(
      ...
      CombatCommon.animations(AnimsPugilistSteve.SPEAR_THRUST),
      CombatCommon.animations(
         ExtraAnimations.SPEAR_TWOHAND_DASH, AnimationsX.SPEAR_TWOHAND_AIR_SLASH, AnimationsX.GRASPING_SPIRAL_FIRST, AnimationsX.GRASPING_SPIRAL_SECOND
      )
   );
}
