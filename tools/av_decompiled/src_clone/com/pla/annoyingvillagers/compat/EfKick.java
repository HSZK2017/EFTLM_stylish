...
public class EfKick {
   public static void tryDealKickStaminaDamage(
      DamageSource damageSource, LivingEntityPatch<?> attackerLivingEntityPatch, AssetAccessor<? extends StaticAnimation> attackerDynamicAnimation
   ) {
      if (attackerDynamicAnimation != null && attackerDynamicAnimation.get() instanceof KickAttackAnimation) {
         EpicfightUtil.dealStaminaDamageByPercentage(damageSource, attackerLivingEntityPatch, (Double)EFKickConfig.KICK_STAMINA_DECREASE_PERCENTAGE.get(), true);
      }
   }
   ...
   public static AnimationAccessor<? extends StaticAnimation>[] basicKickAnimations() {
      return CombatCommon.animations(EFKickAnimations.KICK_1, EFKickAnimations.KICK_2, EFKickAnimations.KICK_3, EFKickAnimations.KICK_4);
   }
}
