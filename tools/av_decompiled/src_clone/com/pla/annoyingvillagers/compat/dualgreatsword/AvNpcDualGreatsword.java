...
public class AvNpcDualGreatsword {
   public static final Builder<MobPatch<?>> DUAL_GREATSWORD = AvNpcCombatBehaviorBuilder.weapon(
      ...
      CombatCommon.animations(DualGreatSwordsAnimations.GREATSWORD_DUAL_DASH, DualGreatSwordsAnimations.GREATSWORD_DUAL_AIRSLASH),
      CombatCommon.animations(AnimsPugilistSteve.GIANT_WHIRLWIND, DualGreatSwordsAnimations.GREATSWORD_EARTH_QUAKE)
   );
}
