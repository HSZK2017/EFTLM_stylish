...
public class EpicFightXDualAxe {
   public static final Function<Item, Builder> X_AXE_DUAL = item -> WeaponCapability.builder()
         ...
         .innateSkill(Styles.ONE_HAND, itemstack -> EpicFightSkillsX.GUILLOTINE_AXE)
         .livingMotionModifier(Styles.ONE_HAND, LivingMotions.IDLE, Animations.BIPED_IDLE)
         .livingMotionModifier(Styles.ONE_HAND, LivingMotions.BLOCK, AnimationsX.SWORD_GUARD)
         .livingMotionModifier(Styles.ONE_HAND, LivingMotions.JUMP, ExtraAnimations.BIPED_JUMP_ONEHAND_LIGHT)
         .livingMotionModifier(Styles.ONE_HAND, LivingMotions.RUN, ExtraAnimations.BIPED_RUN_ONEHAND_LIGHT_ALT)
         .newStyleCombo(
            Styles.TWO_HAND,
            new AnimationAccessor[]{
