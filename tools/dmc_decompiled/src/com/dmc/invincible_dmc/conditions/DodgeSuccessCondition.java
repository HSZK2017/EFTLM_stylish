...
public class DodgeSuccessCondition implements Condition<ServerPlayerPatch> {
   ...
   public boolean predicate(ServerPlayerPatch serverPlayerPatch) {
      ...
      return manager.hasData((SkillDataKey)DMCSkillDataKeys.DODGE_SUCCESS_TIMER.get())
         ? (Integer)manager.getDataValue((SkillDataKey)DMCSkillDataKeys.DODGE_SUCCESS_TIMER.get()) > 0
         : false;
   }
