...
public class ScreenFlashPass extends PostPassBase {
   public ScreenFlashPass(String resourceLocation, ResourceManager resmgr) throws IOException {
   ...
   public void process(
      ...
      this.effect.m_108960_("ColdFade").m_5985_(coldFade);
      this.effect.m_108960_("ColdIntensity").m_5985_(coldIntensity);
      this.effect.m_108960_("ColdColdness").m_5985_(coldColdness);
      this.effect.m_108960_("ColdGrayness").m_5985_(coldGrayness);
