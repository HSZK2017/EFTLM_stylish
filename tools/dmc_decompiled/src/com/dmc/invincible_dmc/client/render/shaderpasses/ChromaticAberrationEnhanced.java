...
public class ChromaticAberrationEnhanced extends PostPassBase {
   public ChromaticAberrationEnhanced(String resourceLocation, ResourceManager resmgr) throws IOException {
      super(resourceLocation, resmgr);
   }

   public void process(RenderTarget inTarget, RenderTarget mask, RenderTarget outTarget, float strength, float progress) {
      ...
      this.effect.m_108960_("DistortionStrength").m_5985_(strength);
