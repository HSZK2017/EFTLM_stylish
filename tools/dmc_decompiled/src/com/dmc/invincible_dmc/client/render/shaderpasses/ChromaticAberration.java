...
public class ChromaticAberration extends PostPassBase {
   public ChromaticAberration(String resourceLocation, ResourceManager resmgr) throws IOException {
   ...
   public void process(
      ...
      this.effect.m_108960_("Direction").m_7971_(directionX, directionY);
      this.effect.m_108960_("BladeLength").m_5985_(bladeLength);
