...
public class ScreenVignettePass extends PostPassBase {
   public ScreenVignettePass(String resourceLocation, ResourceManager resmgr) throws IOException {
      super(resourceLocation, resmgr);
   }

   public void process(RenderTarget inTarget, RenderTarget outTarget, float intensity, float radius, float softness) {
      ...
      this.effect.m_108960_("Softness").m_5985_(softness);
