...
public class ColorRadialBlurPass extends PostPassBase {
   public ColorRadialBlurPass(String resourceLocation, ResourceManager resmgr) throws IOException {
      super(resourceLocation, resmgr);
   }

   public void process(RenderTarget inTarget, RenderTarget outTarget, float centerX, float centerY, float intensity, int samples, float chromaProgress) {
