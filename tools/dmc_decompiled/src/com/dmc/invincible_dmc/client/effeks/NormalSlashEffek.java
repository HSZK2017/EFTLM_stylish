...
@OnlyIn(Dist.CLIENT)
public class NormalSlashEffek {
   public static final ResourceLocation SLASHEFFEK = new ResourceLocation("invincible_dmc", "slash");

   public static void playSlash(NormalSlashEffek.Type type, Level level, double x, double y, double z, float rx, float ry, float rz, float radius) {
   ...
   public static record Type(ResourceLocation effekId, float intrinsicRadius) {
      public static final NormalSlashEffek.Type LEVEL1 = new NormalSlashEffek.Type(NormalSlashEffek.SLASHEFFEK, 1.0F);
   }
}
