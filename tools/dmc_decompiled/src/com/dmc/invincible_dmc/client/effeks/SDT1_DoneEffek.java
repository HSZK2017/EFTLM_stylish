...
@OnlyIn(Dist.CLIENT)
public class SDT1_DoneEffek {
   public static final ResourceLocation SDT1_DONE_EFFEK = new ResourceLocation("invincible_dmc", "sdt1_done");

   public static void playSDT1Done(SDT1_DoneEffek.Type type, Level level, double x, double y, double z, float radius, Entity entity) {
      if (EffekConfig.isEnabled("sdt1_done")) {
   ...
   public static Particle createParticleWrapper(
      SDT1_DoneEffek.Type type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz, float radius
   ) {
   ...
   public static record Type(ResourceLocation effekId, float intrinsicRadius) {
      public static final SDT1_DoneEffek.Type LEVEL1 = new SDT1_DoneEffek.Type(SDT1_DoneEffek.SDT1_DONE_EFFEK, 1.0F);
   }
}
