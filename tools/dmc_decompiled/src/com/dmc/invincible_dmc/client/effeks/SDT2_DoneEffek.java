...
@OnlyIn(Dist.CLIENT)
public class SDT2_DoneEffek {
   public static final ResourceLocation SDT2_DONE_EFFEK = new ResourceLocation("invincible_dmc", "sdt2_done");

   public static void playSDT2Done(SDT2_DoneEffek.Type type, Level level, double x, double y, double z, float radius, Entity entity) {
      if (EffekConfig.isEnabled("sdt2_done")) {
   ...
   public static Particle createParticleWrapper(
      SDT2_DoneEffek.Type type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz, float radius
   ) {
   ...
   public static record Type(ResourceLocation effekId, float intrinsicRadius) {
      public static final SDT2_DoneEffek.Type LEVEL1 = new SDT2_DoneEffek.Type(SDT2_DoneEffek.SDT2_DONE_EFFEK, 1.0F);
   }
}
