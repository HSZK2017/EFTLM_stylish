...
@OnlyIn(Dist.CLIENT)
public class SlowSlashEffek {
   public static final ResourceLocation SLASHEFFEK = new ResourceLocation("invincible_dmc", "slow_slash");

   public static void playSlash(SlowSlashEffek.Type type, Level level, double x, double y, double z, float rx, float ry, float rz, float radius) {
   ...
   public static record Type(ResourceLocation effekId, float intrinsicRadius) {
      public static final SlowSlashEffek.Type LEVEL1 = new SlowSlashEffek.Type(SlowSlashEffek.SLASHEFFEK, 1.0F);
   }
}
