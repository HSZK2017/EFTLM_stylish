...
@OnlyIn(Dist.CLIENT)
public class NormalAdjustSlashEffek {
   public static final ResourceLocation SLASHEFFEK = new ResourceLocation("invincible_dmc", "adjust_slash");

   public static void playSlash(NormalAdjustSlashEffek.Type type, Level level, double x, double y, double z, float rx, float ry, float rz, float radius) {
   ...
   public static record Type(ResourceLocation effekId, float intrinsicRadius) {
      public static final NormalAdjustSlashEffek.Type LEVEL1 = new NormalAdjustSlashEffek.Type(NormalAdjustSlashEffek.SLASHEFFEK, 1.0F);
   }
}
