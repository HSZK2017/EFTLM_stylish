...
@OnlyIn(Dist.CLIENT)
public class SheathEffek {
   public static final ResourceLocation SLASHEFFEK = new ResourceLocation("invincible_dmc", "sheath");

   public static void playSlash(SheathEffek.Type type, Level level, double x, double y, double z, float rx, float ry, float rz, float radius) {
      if (EffekConfig.isEnabled("sheath")) {
   ...
   public static record Type(ResourceLocation effekId, float intrinsicRadius) {
      public static final SheathEffek.Type LEVEL1 = new SheathEffek.Type(SheathEffek.SLASHEFFEK, 1.0F);
   }
}
