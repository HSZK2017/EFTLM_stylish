...
public class DisorderEffek {
   public static final ResourceLocation DISORDER_EFFEK = new ResourceLocation("invincible_dmc", "yamato_disorder");

   public static void playDisorder(DisorderEffek.Type type, Level level, double x, double y, double z, float radius) {
      if (EffekConfig.isEnabled("jce_disorder")) {
   ...
   public static record Type(ResourceLocation effekId, float intrinsicRadius) {
      public static final DisorderEffek.Type LEVEL1 = new DisorderEffek.Type(DisorderEffek.DISORDER_EFFEK, 1.0F);
   }
}
