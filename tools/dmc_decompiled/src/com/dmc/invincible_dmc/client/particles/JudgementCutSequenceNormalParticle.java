...
@OnlyIn(Dist.CLIENT)
public class JudgementCutSequenceNormalParticle extends TextureSheetParticle {
   private static final float SOURCE_HEIGHT = 636.0F;
   private static final float WIDTH_SCALE = 0.7987421F;
   private static final float HEIGHT_SCALE = 0.7358491F;
   private final SpriteSet sprites;
   private final Quaternionf renderRotation = new Quaternionf();

   protected JudgementCutSequenceNormalParticle(ClientLevel level, double x, double y, double z, SpriteSet sprites) {
      super(level, x, y, z);
   ...
   public void m_5744_(VertexConsumer buffer, Camera camera, float partialTick) {
      ...
      float halfWidth = size * 0.7987421F;
      float halfHeight = size * 0.7358491F;
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         ...
         return new JudgementCutSequenceNormalParticle(level, x, y, z, this.sprites);
      }
   }
}
