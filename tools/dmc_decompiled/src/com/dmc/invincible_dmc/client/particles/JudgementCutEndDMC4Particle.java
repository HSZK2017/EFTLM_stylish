...
@OnlyIn(Dist.CLIENT)
public class JudgementCutEndDMC4Particle extends TextureSheetParticle {
   private static final float SOURCE_HEIGHT = 636.0F;
   private static final float WIDTH_SCALE = 1.3899372F;
   private static final float HEIGHT_SCALE = 1.0F;
   private final SpriteSet sprites;
   private final Quaternionf renderRotation = new Quaternionf();

   protected JudgementCutEndDMC4Particle(ClientLevel level, double x, double y, double z, SpriteSet sprites) {
      super(level, x, y, z);
   ...
   public void m_5744_(VertexConsumer buffer, Camera camera, float partialTick) {
      ...
      float halfWidth = size * 1.3899372F;
      float halfHeight = size * 1.0F;
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(
         ...
         return new JudgementCutEndDMC4Particle(level, x, y, z, this.sprites);
      }
   }
}
