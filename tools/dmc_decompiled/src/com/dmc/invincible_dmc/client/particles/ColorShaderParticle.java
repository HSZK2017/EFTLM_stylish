...
@OnlyIn(Dist.CLIENT)
public class ColorShaderParticle extends HitParticle {
   private float hue = this.f_107223_.m_188501_();

   public ColorShaderParticle(ClientLevel world, double x, double y, double z, SpriteSet animatedSprite) {
      super(world, x, y, z, animatedSprite);
      this.updateColorFromHue();
      this.f_107227_ = 1.0F;
      this.f_107228_ = 1.0F;
      this.f_107229_ = 1.0F;
      this.f_107663_ = 3.6479998F;
      this.f_107225_ = 29;
   ...
   public void m_5744_(@NotNull VertexConsumer buffer, @NotNull Camera renderInfo, float partialTicks) {
      if (PostEffectPipelines.isActive()) {
         ...
         if (ageRatio < 0.05F) {
            ...
            size = this.f_107663_ * t * t * t;
         } else if (ageRatio > 0.95F) {
            float t = (1.0F - ageRatio) / 0.05F;
            size = this.f_107663_ * t * t * t;
         } else {
            size = this.f_107663_;
         }
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Provider(SpriteSet spriteSet) {
         ...
         SdtPhase2Particle.SHARED_SPRITE_SET = spriteSet;
      }

      public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         return new ColorShaderParticle(worldIn, x, y, z, this.spriteSet);
      }
   }
}
